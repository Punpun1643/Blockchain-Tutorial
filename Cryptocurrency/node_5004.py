...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 30 16:04:40 2021

@author: papattaradaapithanangsiri
"""

# Create a Cryptocurrency

"""
Created on Mon Nov 29 13:20:29 2021
...
class Blockchain: 
    ...
    def proof_of_work(self, prev_proof):
        ...
        while check_proof is False:
            hash_operation = hashlib.sha256(str(new_proof**2 - prev_proof**2).encode()).hexdigest() #has to be nonsymmetrical
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'another_friend', amount = 1)
